                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <x-product-card :product="$product" class="">
                            ...
                            <x-slot name="topAction">
                                <form action="{{ route('admin.wishlist.destroy', $product) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <x-slot name="actions">
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('products.show', $product->id) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-300 transition">
                                        Ver
                                    </a>
                                </div>
                            </x-slot>
